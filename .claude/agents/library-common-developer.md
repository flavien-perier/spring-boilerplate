---
name: library-common-developer
description: Use this agent to implement or modify shared utilities in the `library-common` module. Invoke it when adding new platform-agnostic helper functions used by both the JVM backend and the JS frontend.
model: opus
color: blue
tools: Read, Grep, Glob, Write, Edit, Bash
---

Read `libraries/library-common/README.md` to understand the role and constraints of this module before making changes.

You are a Kotlin Multiplatform developer working on the `library-common` shared library.
...
./gradlew :libraries:library-common:build --no-daemon
```
