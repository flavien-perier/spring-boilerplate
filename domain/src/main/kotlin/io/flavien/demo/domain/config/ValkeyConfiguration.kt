...
@Configuration
@EnableRedisRepositories(basePackageClasses = [AccessTokenRepository::class, RefreshTokenRepository::class, ForgotPasswordRepository::class, UserActivationRepository::class])
